...
PROMPT_TEMPLATE = """
You are recruiting participants for a clinical trial. 
    - Use the provided context to answer the query.
    - keep the answers concise and factual, with a minimum of three sentences.
...
def generate_answer(context_documents):
...
ai_response = generate_answer(relevant_docs)
print(ai_response)
